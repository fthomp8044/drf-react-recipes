...
SECRET_KEY = 't29%f-6#07+zkxj8nwijx^^jogedxf*^$xdqvlssf%5ni+0s4)'
...
#if the we have this database url set, then i want you to use the database we point to , otherwise use the default sqlite3 database.
...
AWS_STORAGE_BUCKET_NAME = 'drf-react-recipes-fthomp2430'
